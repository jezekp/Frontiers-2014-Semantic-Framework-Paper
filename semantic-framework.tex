...
\emph{$\forall$  $J{}_{\text{i}}$ is a superclass of $J{}_{\text{j}}$ $\exists$ $OC{}_{\text{i}}$ is a superclass of $OC{}_{\text{j}}$  $\in$  O; $OC$ is OWL class; i $\in$ \{1..n\}; n is number of JavaBeans; j $\in$ \{1..m\}; m is number of subclasses $\in$ $J{}_{\text{i}}$}.
...
\emph{$\forall$ $J{}_{\text{inst}}$ $\in$  $J{}_{\text{i}}$ $\bigwedge$ $\forall$ $Jf{}_{\text{ij}}$  $\exists$ $OL{}_{\text{ij}}$ $\in$ O $\hat{=}$ $Jf{}_{\text{ij}}$ $\in$ $J{}_{\text{i}}$; $J{}_{\text{inst}}$ is instance of $J{}_{\text{i}}$; $Jf{}_{\text{ij}}$ is field $\in$ $J{}_{\text{i}}$;  i $\in$ \{1..n\}; n is number of JavaBeans; j $\in$ \{1..m\}; m is number of fields $\in$ $J{}_{\text{i}}$; $OL{}_{\text{ij}}$ is OWL literal}.
