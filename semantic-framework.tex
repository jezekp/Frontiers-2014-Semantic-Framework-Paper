...
An example of using two annotations is given in Listing~\ref{Annotated_Java_Bean_Example}. The class Experiment has an attribute testedPerson as defined in Listing~\ref{Java_class_property_Definition}. The first annotation defines the class Experiment as an~\emph{equivalent class} to the class Measurement. The second annotation defines the testedPerson property as an \emph{equivalent property} to the testedSubject property. The serialization of this JavaBean is shown in Listing~\ref{Annotated_Java_Bean_OWL_Serialization}.
