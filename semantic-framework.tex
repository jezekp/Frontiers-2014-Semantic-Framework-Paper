...
\emph{$\forall$ $Jf{}_{\text{j}}$ $\exists$  $OC{}_{\text{i}}$ $\in$  O; its $OC{}_{\text{i}}$ extent is a DataType property $\in$  O $\Leftrightarrow$ $Jf{}_{\text{j}}$ extent is an atomic type; $OC{}_{\text{i}}$ is OWL class; $Jf{}_{\text{j}}$ is field $\in$  $J{}_{\text{i}}$; i $\in$ \{1..n\}; n is number of OC; j $\in$ \{1..m\}; m is number of $J{}_{\text{i}}$ fields}.

\emph{$\forall$  $Jf{}_{\text{j}}$ $\exists$ $OC{}_{\text{i}}$ $\in$ O; its  $OC{}_{\text{i}}$ extent is an Object property $\Leftrightarrow$ $Jf{}_{\text{j}}$ extent is a class $\in$ $J{}_{\text{i}}$ $Jf{}_{\text{j}}$ is field $\in$ J; i $\in$ \{1..n\}; n is number of $OC{}_{\text{i}}$; j $\in$ \{1..m\}; m is number of $J{}_{\text{i}}$ fields}.
