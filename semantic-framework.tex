...
\label{intro}
Our research group specializes in brain activity research. Experiments conducted in our laboratory, in which the techniques of electroencephalography (EEG) and event related potentials (ERP) are used, are mainly focused on recording and analysis of cognitive event related potentials. Experimental work is very time consuming and vast amounts of experimental data and related metadata are produced at various stages of processing from primary data recording to final interpretation of data. When the number of experiments increases, the need to find a mature system for storing, managing and sharing data (at least within the research group) increases. This need is more crucial when researchers want to share their data, processing steps or even interpretation results within wider community. Then the most pressing difficulties are an absence of standardized and generally used data formats and well-defined metadata descriptions \cite{data-sharing-for-computational-neuroscience}.
