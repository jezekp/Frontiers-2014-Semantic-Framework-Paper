...
\emph{$\forall$ $J{}_{\text{inst}}$ of  $J{}_{\text{i}}$ $\bigwedge$ $\forall$ $Jf{}_{\text{ij}}$  $\exists$ $OL{}_{\text{ij}}$ $\in$ O so that $OL{}_{\text{ij}}$ $\hat{=}$ $Jf{}_{\text{ij}}$; $J{}_{\text{inst}}$ is an instance of $J{}_{\text{i}}$; $Jf{}_{\text{ij}}$ is a~field of $J{}_{\text{i}}$;  i $\in$ \{1..n\}; n is the number of JavaBeans; j $\in$ \{1..m\}; m is the number of $J{}_{\text{i}}$ fields; $OL{}_{\text{ij}}$ is an OWL literal}.
