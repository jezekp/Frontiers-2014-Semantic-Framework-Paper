...
\emph{$\forall$ $Jf{}_{\text{j}}$ $\exists$  $OC{}_{\text{i}}$ $\in$  O; its $OC{}_{\text{i}}$ extent is a~DataType property $\in$  O $\Leftrightarrow$ $Jf{}_{\text{j}}$ is an atomic type; $OC{}_{\text{i}}$ is an OWL class; $Jf{}_{\text{j}}$ is field $\in$  $J{}_{\text{i}}$; i $\in$ \{1..n\}; n is the number of OC; j $\in$ \{1..m\}; m is the number of $J{}_{\text{i}}$ fields}.

\emph{$\forall$  $Jf{}_{\text{j}}$ $\exists$ $OC{}_{\text{i}}$ $\in$ O; its  $OC{}_{\text{i}}$ extent is an Object property $\Leftrightarrow$ $Jf{}_{\text{j}}$ is a~class $\in$ $J{}_{\text{i}}$ $Jf{}_{\text{j}}$ is field $\in$ J; i $\in$ \{1..n\}; n is the number of $OC{}_{\text{i}}$; j $\in$ \{1..m\}; m is the number of $J{}_{\text{i}}$ fields}.

\emph{$\forall$ $J{}_{\text{inst}}$ $\in$  $J{}_{\text{i}}$ $\bigwedge$ $\forall$ $Jf{}_{\text{ij}}$  $\exists$ $OL{}_{\text{ij}}$ $\in$ O $\hat{=}$ $Jf{}_{\text{ij}}$ $\in$ $J{}_{\text{i}}$; $J{}_{\text{inst}}$ is instance of $J{}_{\text{i}}$; $Jf{}_{\text{ij}}$ is field $\in$ $J{}_{\text{i}}$;  i $\in$ \{1..n\}; n is the number of JavaBeans; j $\in$ \{1..m\}; m is the number of $J{}_{\text{i}}$ fields; $OL{}_{\text{ij}}$ is an OWL literal}.
